...
def juego_adivinanza():
    ...
    while not adivinado:
        ...
        if (adivinanza.isdigit()):
            adivinanza = int(adivinanza)  # Pasa de texto a entero
            intentos += 1
            ...
            if (adivinanza < numero_secreto):
                ...
                print(f"¡Felicitaciones has ganado! El número {adivinanza} es el secreto y los has adivinado en {intentos} intentos.")
        else:
